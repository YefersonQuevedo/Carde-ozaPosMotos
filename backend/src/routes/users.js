...
import { roleExists } from "../permissions.js";
...
// Rol valido = admin, built-in o rol personalizado existente; si no, vendedor.
const normRole = async (r) => ((r === "admin" || (await roleExists(r))) ? r : "vendedor");
...
router.put("/:id", async (req, res, next) => {
  try {
    ...
    const b = req.body || {};
    const data = { name: b.name, role: await normRole(b.role), active: b.active !== false };
